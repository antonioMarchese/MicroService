...
let NotificationsController = class NotificationsController {
    ...
    async countFromRecepient(recipientId) {
        const { count } = await this.countRecipientNotifications.execute({
            recipientId,
        });
        return { count };
    }
    async getFromRecepient(recipientId) {
    ...
    async create(body) {
        ...
        const raw = notification_view_model_1.NotificationViewModel.toHTTP(notification);
        return {
            notification: raw,
        };
    }
...
__decorate([
    ...
    __param(0, (0, decorators_1.Param)('recipientId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "countFromRecepient", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], NotificationsController.prototype, "getFromRecepient", null);
__decorate([
